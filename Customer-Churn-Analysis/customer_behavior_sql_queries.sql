...
--which customers used a disocunt,but still spent more than the average product amount?
...
--segement customers into New,Returning and Loyal based on their total number of previous purchases and show the count of each segement.
